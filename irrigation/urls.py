...
urlpatterns = [
    ...
    path('request/<int:pk>/payment-method/', views.select_irrigation_payment_method, name='irrigation_payment_method'),
    path('request/<int:pk>/receipt/', views.irrigation_receipt, name='irrigation_receipt'),
