...
urlpatterns = [
    ...
    path('rice-sales/pricing/', views.rice_sales_pricing, name='rice_sales_pricing'),
    path('rice-sales/stock-movement/', views.rice_sales_stock_movement, name='rice_sales_stock_movement'),
    path('rice-sales/order-records/', views.rice_sales_order_records, name='rice_sales_order_records'),
    ...
    path('rice-sales/export/excel/', views.export_rice_sales_report_excel, name='export_rice_sales_report_excel'),
    path('rice-sales/export/pdf/', views.export_rice_sales_report_pdf, name='export_rice_sales_report_pdf'),
