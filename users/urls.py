...
urlpatterns = [
    ...
    path('dashboard/api/summary/', views.dashboard_data, name='dashboard_data'),
    path('dashboard/dismiss-approval-banner/', views.dismiss_approval_banner, name='dismiss_approval_banner'),
